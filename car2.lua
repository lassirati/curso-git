...
access_tag_blacklist = { ["no"] = true, ["discouraged"] = true, ["private"] = true, ["agricultural"] = true, ["forestry"] = true, ["emergency"] = true, ["psv"] = true, ["delivery"] = true }
access_tag_restricted = { ["destination"] = true, ["delivery"] = true }
access_tags_hierarchy = { "goods", "hgv", "motorcar", "motor_vehicle", "vehicle", "access" }
...
surface_speeds = {
  ["asphalt"] = 80,    -- nil mean no limit. removing the line has the same effect
  ["concrete"] = 80,
  ["concrete:plates"] = nil,
  ["concrete:lanes"] = nil,
  ["paved"] = 80,
